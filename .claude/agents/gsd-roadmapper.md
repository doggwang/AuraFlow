...
Reference full template: `D:/Project/vibe coding/AuraFlow/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `D:/Project/vibe coding/AuraFlow/.claude/get-shit-done/templates/state.md`.
