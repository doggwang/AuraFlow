...
- **Global scope**: `D:/Project/vibe coding/AuraFlow/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `D:/Project/vibe coding/AuraFlow/.claude/notes/`)
...
2. Glob `D:/Project/vibe coding/AuraFlow/.claude/notes/*.md` (if directory exists) — global notes
...
Global (D:/Project/vibe coding/AuraFlow/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `D:/Project/vibe coding/AuraFlow/.claude/notes/` — works in any directory
