...
<execution_context>
@D:/Project/vibe coding/AuraFlow/.claude/get-shit-done/workflows/session-report.md
</execution_context>

<process>
Execute the session-report workflow from @D:/Project/vibe coding/AuraFlow/.claude/get-shit-done/workflows/session-report.md end-to-end.
</process>
